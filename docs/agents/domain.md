...
This repo uses a **multi-context** layout: a `CONTEXT-MAP.md` at the root points at one `CONTEXT.md` per context.
...
For reference, a single-context repo would instead have one `CONTEXT.md` + `docs/adr/` at the root.
