...
edits, text anchors are the most robust (they don't depend on index ranges).
See the [CLI reference](../07-cli-reference/edit.md) for the full rationale and
the chunker-accuracy note.
